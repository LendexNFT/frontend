  ...
  return (
    <div className="grid grid-cols-4 justify-center items-center relative">
      ...
      >
        ...
        <button type="button" className="lg:border-0 border border-whites hover:skew-x-12 transitione bt-linear font-semibold text-whites text-sm py-3 px-8 rounded">
          Launch App
        </button>
      </div>
    </div>
