		...
		<div className={`update-table w-full p-8 bg-white overflow-hidden rounded-2xl section-shadow ${className || ''}`}>
			<div className='header w-full sm:flex justify-between items-center mb-5'>
				<div className='flex space-x-2 items-center mb-2 sm:mb-0'>
					<h1 className='text-xl font-bold text-dark-gray tracking-wide'>LAST TRANSACTIONS</h1>
					<span className='w-7 h-7 flex justify-center items-center bg-pink text-white text-xs rounded-full'>5</span>
				</div>
			</div>
					...
					<tbody>
						...
						<tr className='bg-white border-b hover:bg-gray-50'>
							<td className='py-4'>
								<div className='flex space-x-2 items-center'>
									<div className='w-[60px] h-[60px] rounded-full overflow-hidden flex justify-center items-center'>
										<img src={dataImage1} alt='data' className='w-full h-full' />
									</div>
									<div className='flex flex-col'>
										<table>
											<tbody>
												<tr>
													<td>
														<h1 className='font-bold text-xl text-dark-gray'>Lethal sword</h1>
													</td>
													<td>
							...
							<td className='text-center py-4 px-2'>
								<div className='flex space-x-1 items-center justify-center'>
									<span className='text-base text-dark-gray font-medium'>
										<h1 className='font-bold text-xl text-dark-gray'>SWAP</h1>
									</span>
								</div>
							</td>
									...
									<div className='flex flex-col'>
										<table>
											<tbody>
												<tr>
													<td>
														<h1 className='font-bold text-xl text-dark-gray'>Steel Shield</h1>
													</td>
													<td>
														<span className='pl-5 font-bold text-sm text-thin-dark-gray'>QTY:</span>
														<span className='pl-2 text-sm text-thin-light-gray'>1</span>
							...
							<td className='py-4 text-center'>
								<span className='text-base  text-thin-light-gray whitespace-nowrap px-2'>--</span>
							</td>
							<td className='text-center py-4'>
								<button type='button' className='text-sm text-white bg-purple px-2.5 py-1.5 rounded-full'>
									Open
								</button>
							</td>
						</tr>
						<tr className='bg-white border-b hover:bg-gray-50'>
							<td className='py-4'>
								<div className='flex space-x-2 items-center'>
									<div className='w-[60px] h-[60px] rounded-full overflow-hidden flex justify-center items-center'>
										<img src={dataImage4} alt='data' className='w-full h-full' />
									</div>
									<div className='flex flex-col'>
										<table>
											<tbody>
												<tr>
													<td>
														<h1 className='font-bold text-xl text-dark-gray'>Blue Metal Shark</h1>
													</td>
													<td>
														<span className='pl-5 font-bold text-sm text-thin-dark-gray'>QTY:</span>
														<span className='pl-2 text-sm text-thin-light-gray'>1</span>
												...
												<tr>
													<td colSpan={2}>
														<span className='font-bold text-sm text-thin-dark-gray'>Reserved To:</span>
														<span className='pl-2 text-sm text-thin-dark-gray'>
															0xf0e974aC48d9d33184Ac7B46Ba45372E3d6DdEE2
														</span>
													</td>
												</tr>
											</tbody>
							...
							<td className='py-4 px-4'>
								<div className='flex space-x-2 items-center'>
									<div className='w-[60px] h-[60px] rounded-full overflow-hidden flex justify-center items-center'>
										<img src={dataImage3} alt='data' className='w-full h-full' />
									</div>
									<div className='flex flex-col'>
										<table>
											<tbody>
												<tr>
													<td>
														<h1 className='font-bold text-xl text-dark-gray'>Golden lightning Tiger</h1>
													</td>
													<td>
														<span className='pl-5 font-bold text-sm text-thin-dark-gray'>QTY:</span>
														<span className='pl-2 text-sm text-thin-light-gray'>1</span>
						...
						<tr className='bg-white border-b hover:bg-gray-50'>
							...
							<td className='text-center py-4 px-2'>
								<div className='flex space-x-1 items-center justify-center'>
									<span className='text-base text-dark-gray font-medium'>
										<h1 className='font-bold text-xl text-dark-gray'>LEND</h1>
									</span>
								</div>
							</td>
							<td className='py-4 px-4'>
							...
							<td className='py-4 text-center'>
								<span className='text-base text-thin-light-gray whitespace-nowrap px-2'>2Days 12Hs</span>
							</td>
							<td className='text-center py-4'>
								<span className='text-sm text-white bg-light-green px-2.5 py-1.5 rounded-full'>Fulfilled</span>
							</td>
						...
						<tr className='bg-white border-b hover:bg-gray-50'>
							...
							<td className='py-4 text-center'>
								<span className='text-base  text-thin-light-gray whitespace-nowrap px-2'>10 Days</span>
							</td>
							<td className='text-center py-4'>
								<button type='button' className='text-sm text-white bg-purple px-2.5 py-1.5 rounded-full'>
									Open
						...
						<tr className='bg-white border-b hover:bg-gray-50'>
							...
							<td className='text-center py-4 px-2'>
								<div className='flex space-x-1 items-center justify-center'>
									<span className='text-base text-dark-gray font-medium'>
										<h1 className='font-bold text-xl text-dark-gray'>BORROW</h1>
									</span>
								</div>
							</td>
							<td className='py-4 px-4'>
									...
									<div className='flex flex-col'>
										<table>
											<tbody>
												<tr>
													<td>
														<h1 className='font-bold text-xl text-dark-gray'>Golden Tiger</h1>
													</td>
													<td>
														<span className='pl-5 font-bold text-sm text-thin-dark-gray'>QTY:</span>
							...
							<td className='py-4 text-center'>
								<span className='text-base  text-thin-light-gray whitespace-nowrap px-2'>15 Days</span>
							</td>
							<td className='text-center py-4'>
								<button type='button' className='text-sm text-white bg-purple px-2.5 py-1.5 rounded-full'>
									Open
