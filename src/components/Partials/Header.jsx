        ...
        <ModalCom action={addMoneyHandler} situation={moneyPopup}>
          <div className="lg:w-[580px] sm:w-[450px] w-full rounded-2xl h-auto bg-white">
            ...
            <div className="content lg:px-7 px-3 sm:px-5 py-8">
              <ul>
                <li className="content-item px-5 py-2.5 lg:mb-8 mb-3 border rounded-lg b border-light-purple hover:border-purple" style={{ boxShadow: "0px 16px 93px 0px #55526329" }}>
                  <div className="sm:flex justify-between items-center">
                    <div className="account-name flex space-x-4 items-center mb-2 sm:mb-0">
                      ...
                      <div className="name">
                        <p className="text-xl font-bold text-dark-gray">MetaMask</p>
                      </div>
                    </div>
                    <div>
                      <button type="button" className="w-[122px] h-11 flex justify-center items-center border-gradient text-base rounded-full text-back">
                        <span className="text-gradient" onClick={() => userData ? disconnectWallet() : connectWallet()}>
                          {" "}
                ...
                <li className="content-item px-5 py-2.5 lg:mb-8 mb-3 border rounded-lg b border-light-purple hover:border-purple" style={{ boxShadow: "0px 16px 93px 0px #55526329" }}>
                  <div className="sm:flex justify-between items-center">
                    <div className="account-name flex space-x-4 items-center mb-2 sm:mb-0">
                      ...
                      <div className="name">
                        <p className="text-xl font-bold text-dark-gray">WalletConnect</p>
                      </div>
                    </div>
                    <div>
                      <button type="button" className="w-[122px] h-11 flex justify-center items-center border-gradient text-base rounded-full text-black">
