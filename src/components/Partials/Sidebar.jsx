...
export default function Sidebar ({ sidebar, action, logoutModalHandler }) {
  ...
  return (
    <div className="w-full h-full">
      {/* logo-area */}
      <div
        className={`w-full flex items-center transition-all duration-300 ease-in-out ${sidebar ? "justify-between  mb-14" : "justify-center"
          }`}
      >
      ...
      <div className="menu-setting-items mb-11">
        {/* menus item */}
        <div
          className={`menu-item transition-all duration-300 ease-in-out ${sidebar ? "mb-14" : ""
            }`}
        >
