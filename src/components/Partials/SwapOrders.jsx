		...
		<div className={`update-table w-full p-8 bg-white overflow-hidden rounded-2xl section-shadow ${className || ''}`}>
			<div className='header w-full sm:flex justify-between items-center mb-5'>
				<div className='flex space-x-2 items-center mb-2 sm:mb-0'>
					<h1 className='text-xl font-bold text-dark-gray tracking-wide'>SWAP ORDERS</h1>
					<span className='w-7 h-7 flex justify-center items-center bg-pink text-white text-xs rounded-full'>35</span>
				</div>
			</div>
					...
					<tbody>
						...
						<tr className='bg-white border-b hover:bg-gray-50'>
							...
							<td className='py-4 px-4'>
								<div className='flex space-x-2 items-center'>
									<div className='w-[60px] h-[60px] rounded-full overflow-hidden flex justify-center items-center'>
										<img src={dataImage5} alt='data' className='w-full h-full' />
									</div>
									<div className='flex flex-col'>
										<table>
											<tr>
												<td>
													<h1 className='font-bold text-xl text-dark-gray'>MATIC</h1>
												</td>
												<td>
													<span className='pl-5 font-bold text-sm text-thin-dark-gray'>QTY:</span>
