			...
			<div className='content'>
				...
				<div className='w-full h-40'>
					...
					<div
						...
						style={{
							background: `url(${localImgLoad(`images/${datas.thumbnil}`)}) 0% 0% / cover no-repeat`,
						}}
					>
				...
				<div className='user w-ful -mt-6 mb-2'>
					<div className='user-img w-10 h-10 flex  justify-center items-center overflow-hidden rounded-full mb-2 ml-4'>
						<img src={localImgLoad(`images/${datas.profile_img}`)} alt='user' className=' w-full h-full' />
					</div>
				...
				<div className='details'>
					{/* product title */}
					<Link to='#' className='text-xl font-bold text-dark-gray mb-2 capitalize line-clamp-1'>
						{datas.title}
					</Link>
					{/* countdown */}
					<div className='w-full h-[54px] flex justify-evenly items-center p-1 rounded-lg border border-[#E3E4FE]'>
						<div className='flex flex-col justify-between'>
							...
							<p className={`text-xs ${datas.interest === 'Paid' ? 'text-green-600' : 'text-red-400'}`}>
								{datas.interest}
							</p>
							<p className='text-sm font-bold tracking-wide text-dark-gray'>{datas.price}</p>
						</div>
